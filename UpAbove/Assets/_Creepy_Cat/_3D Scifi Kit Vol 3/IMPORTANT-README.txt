...
- Install the Unity Prost Processing Stack
...
Believe that a kit can solves all your game design issues for $50, and without working, 
is a heresy :)
...
- Fix the metal map for diffuse 12
- Make a rack for missils for ships